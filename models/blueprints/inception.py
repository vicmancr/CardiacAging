...
class Inception3(nn.Module):
    def __init__(
        ...
        self.Conv2d_1a_3x3 = conv_block(num_channels, 32, kernel_size=3, stride=2)
    ...
    @torch.jit.unused
    def eager_outputs(self, x: Tensor, out: Tensor, aux: Optional[Tensor]) -> InceptionOutputs:
    ...
    def forward(self, x: Tensor) -> InceptionOutputs:
        ...
        if torch.jit.is_scripting():
            ...
            return self.eager_outputs(x, out, aux)
